...
<!-- Mirrored from htmlstream.com/front-dashboard/account-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Nov 2020 01:58:00 GMT -->
<head>
                ...
                <ul id="navbarSettings" class="js-sticky-block js-scrollspy navbar-nav navbar-nav-lg nav-tabs card card-navbar-nav"
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="#twoStepVerificationSection">
                      <i class="tio-fingerprint nav-icon"></i>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="#socialAccountsSection">
                      <i class="tio-instagram nav-icon"></i>
                      Social accounts
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#deleteAccountSection">
                      <i class="tio-delete-outlined nav-icon"></i>
                      Delete account
                    </a>
                  </li>
                </ul>
              ...
              <div class="card-body">
                ...
                <form>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-sm-9">
                      <!-- Select -->
                      <select class="js-select2-custom" id="languageLabel"
                              data-hs-select2-options='{
                                "minimumResultsForSearch": "Infinity",
...
<!-- Mirrored from htmlstream.com/front-dashboard/account-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Nov 2020 01:58:02 GMT -->
</html>