...
$club2 = $ClubcampingC->recupererClubcampingi($idutilisateur);
foreach ($club2 as $r) {
    header('Location:showclub.php?idClubcamping=' . $r['idClubcamping']);
}
...
if (
    ...
    if (
        ...
        $user->setIduser($idutilisateur);
        $ClubcampingC->ajouterClubcamping($user);
        $club1 = $ClubcampingC->recupererClubcampingn($_POST["nomclub"]);
        foreach ($club1 as $row) {
            header('Location:showclub.php?idClubcamping=' . $row['idClubcamping']);
        }
    } else
                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Ajouter des informations devotre club de camping à notre site camping fever</h3>
                                </div>
                                <div class="card-body">
                                    <form action="" method="POST">
                                        <div class="form-group">
                                            <label for="validationValidInput1">Nom du club</label>
                                            <input type="text" class="form-control is-valid" id="validationValidInput1" placeholder="Placeholder" name="nomclub">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control is-valid" id="validationValidInput1" placeholder="Placeholder" name="nomres">
                                        </div>
                                        <div class="form-group">
                                            <label for="validationValidTextarea1">Contact</label>
                                            <input type="tel" class="form-control is-valid" id="validationValidInput1" placeholder="Placeholder" name="contact">
                                        </div>
                                        <div class="form-group">
                                            <label for="validationValidTextarea1">Nombre des membres du club</label>
                                            <input type="number" class="form-control is-valid" id="validationValidInput1" placeholder="Placeholder" name="nbmembres">
                                        </div>
                                        <div class="form-group">
                                            <label for="validationValidTextarea1">Ajouter votre site officiel </label>
                                            <input type="text" class="form-control is-valid" id="validationValidInput1" placeholder="Placeholder" name="siteclub">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group mt-4 mb-0">
                                            ...
                                            <input class="btn btn-primary btn-block" type="submit" value="Add club">
                                        </div>
                                    </form>
                                </div>
                            </div>
