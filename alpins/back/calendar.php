...
<div class="content bg-info">     
  ...
  <div>
    <!-- Header -->
    <div class="header pb-6 content__title content__title--calendar">
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 mt-3 mt-lg-0 text-lg-right">
              <a class="fullcalendar-btn-prev btn btn-sm btn-neutral">
                <i class="fas fa-angle-left"></i>
              </a>
              <a class="fullcalendar-btn-next btn btn-sm btn-neutral">
