...
)
{
  ...
  )
  {
    ...
    {
      $pathImage = $_POST['eventPhotoC'];
      $test = 1;
    }
    if($test)
    {
      $event = new Event((int) $_POST['eventID'],
                      $_POST['eventName'],
                      $_POST['eventDate'],
                      $_POST['eventPlace'],
                      $_POST['eventContent'],
  ...
  <main id="content" role="main" class="main pointer-event">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Modify Event</li>
      </ol>
    </nav>
    ...
    <div class="content container-fluid">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-sm-auto">
            <a class="btn btn-primary" href="showEvents-back.php">
              <i class="tio-undo mr-1"></i> back to Show Event
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          <h5 class="card-header-title">Edit Event</h5>
          <small class="text-muted"> 
            ...
            if(isset($_GET['eventID']))
            {
              ...
              {
                if($data = $eventC->findEvent((int)$_GET['eventID']))
                {
                  $rows = $data->fetch();

                  $date = new DateTime($rows['setEventDate']);
                  $nbDay = date('d') - $date->format('d');
                  if($nbDay == 0)
                    echo 'Today';
                  else
                    echo $nbDay . 'days ago';                  
        ...
        <div class="card-body">        
          <form action='' method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label class="input-label" for="eventID">Event ID</label>
              <input type="text" name="eventID"  id="eventID" class="form-control" value="<?php echo $rows['eventID']; ?>" readonly>
            </div>

            <div class="form-group">
              <label class="input-label" for="eventName">Event Name</label>
              <input type="text" name="eventName" id="eventName" class="form-control" value="<?php echo $rows['eventName']; ?>" placeholder="nomDeL'evenement">
            </div>
            ...
            <div class="form-group">
              ...
              <div id="projectDeadlineNewProjectFlatpickr" class="js-flatpickr flatpickr-custom input-group input-group-merge"
                ...
                <input type="text" name="eventDate" class="flatpickr-custom-form-control form-control" id="projectDeadlineFlatpickrNewProjectLabel" placeholder="Select dates" data-input value="<?php echo $rows['eventDate']; ?>">
              </div>
            </div>
            <!-- End Form Group -->
            ...
            <div class="form-group">              
              ...
              <div class="input-group-merge">
                ...
                <input type="text" name="eventPlace" id="eventPlace" class="form-control" value="<?php echo $rows['eventPlace']; ?>" placeholder="LieuDeL'evenement">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              }'><?php echo $rows['eventContent']; ?></textarea>
            </div>
              ...
              <label class="custom-file-boxed" for="eventPhoto">
                <div class="dz-message custom-file-boxed-label">                  
                  ...
                  <div id="customFileBoxedEg">                    
                    <img class="mb-1" src='<?php echo $rows['eventPhoto']; ?>' style="width: 300px; height: 250px">                    
                  </div>
                ...
                <input id="eventPhoto" name="eventPhoto" type="file" class="js-file-attach custom-file-boxed-input"
                       ...
                       }' value="<?php echo $rows['eventPhoto']; ?>">
                <input type="hidden" name="eventPhotoC" value="<?php echo $rows['eventPhoto']; ?>" />
              </label>
            ...
            <div class="form-group">
              ...
              <div class="input-group-merge">
                ...
                <input type="text" name="eventAuthor"  id="eventAuthor" class="form-control" value="<?php echo $rows['eventAuthor']; ?>" readonly>
              </div>
            </div>
            <div class="d-flex justify-content-center">           
              <p class="card-text">Edit event with this form.</p>
            </div>
