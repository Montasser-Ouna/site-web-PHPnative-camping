...
<!-- Mirrored from htmlstream.com/front-dashboard/user-profile-my-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Nov 2020 01:57:59 GMT -->
<head>
    ...
    <!-- Title -->
    <title>My Profile | Front - Admin &amp; Dashboard Template</title>
        ...
        <div class="row justify-content-lg-center">
          <div class="col-lg-10">
            ...
            <div class="text-center mb-5">
              ...
              <h1 class="page-title">Mark Williams <i class="tio-verified tio-lg text-primary" data-toggle="tooltip" data-placement="top" title="Top endorsed"></i></h1>
              ...
              <div class="col-lg-8">
                ...
                <div class="card mb-3 mb-lg-5">
                  ...
                  <div class="card-body card-body-height card-body-centered">
                    <img class="avatar avatar-xxl mb-3" src="assets/svg/illustrations/yelling.svg" alt="Image Description">
                    <p class="card-text">No data to show</p>
                    <a class="btn btn-sm btn-white" href="projects.php">Start your Projects</a>
                  </div>
                  <!-- End Body -->
                </div>
                <!-- End Card -->
