...
session_start();
   ...
   $utilisateur1=$utilisateurc->AfficherUtilisateurs();
   $utilisateur3=$utilisateurc->AfficherUtilisateurs();
    $utilisateur2=$utilisateurc->rowc();
...
<head>
      ...
      <div class="content container-fluid">
        ...
        <div class="page-header">
          <div class="row align-items-end">
            ...
            <div class="col-sm-auto">
              <a class="btn btn-primary" href="ajouterUtilisateur.php">
        ...
        <div class="row gx-2 gx-lg-3">
          <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
            <!-- Card -->
           <?php foreach ($utilisateur2 as $row1) {?>
          ...
          <div class="card h-100">
              <div class="card-body">
                ...
                <div class="row align-items-center gx-2">
                  <div class="col">
                    <span class="js-counter display-4 text-dark"><?php echo $row1['COUNT(*)']?></span>
                  </div>
  ...
  <?php $nba=0;
  foreach ($utilisateur3 as $r) {
    if(strcmp($r['active'],"1")==0)
  $nba++; } ?>
          ...
          <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
            ...
            <div class="card h-100">
              <div class="card-body">
                ...
                <div class="row align-items-center gx-2">
                  <div class="col">
                    <span class="js-counter display-4 text-dark"><?php echo $nba ; ?></span>
                    <span class="text-body font-size-sm ml-1">from <?php echo $row1['COUNT(*)']; ?></span>
                  </div><?php }?>
          ...
          <div class="card-header">
            <div class="row justify-content-between align-items-center flex-grow-1">
              <div class="col-sm-6 col-md-4 mb-3 mb-sm-0">
                <form action="Rechercherutilisateur.php" method="POST">
                  <!-- Search -->
                  <div class="input-group input-group-merge input-group-flush">
                    ...
                    <input id="datatableSearch" name="ch" type="search" class="form-control" placeholder="Search users" aria-label="Search users">
                        <input type="image" name="submit" src="cher.jpg" border="0" alt="Submit" style="width: 50px;" />
          ...
          <div class="table-responsive datatable-custom">
            <table id="datatable" class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
              ...
              <tbody>
                  ...
                  <?php foreach ($utilisateur1 as $row) {?>
                <tr>
                  ...
                  <td class="table-column-pl-0">
                    <a class="d-flex align-items-center" href="../views/showuser.php?id=<?php echo $row['idutilisateur'] ?>">
                      <div class="avatar avatar-circle">

                        <img class="avatar-img" src="<?php echo $row['pdp']?>" alt="Image Description">
                      </div>
                      <div class="ml-3">
                        <span class="d-block h5 text-hover-primary mb-0"><?php echo $row['nom'];?><i class="tio-verified text-primary" data-toggle="tooltip" data-placement="top" title="Top endorsed"></i></span>
                        <span class="d-block font-size-sm text-body"></span>
                      </div>
                    </a>
                  </td>
                  <td>
                    <span class="d-block h5 mb-0"><?php echo $row['prenom'];?></span>
                    <span class="d-block font-size-sm"></span>
                  </td>
                  <td><?php echo $row['ville'];?><span class="text-hide">Code: GB</span></td>
                  <td>
                    <span class="legend-indicator bg-success"></span>Active
                  </td>
                  <td>
                    <div class="d-flex align-items-center">
                      <span class="font-size-sm mr-2"><?php echo $row['tel'];?></span>
                      </div>
                    </div>
                  </td>
                  <td><?php echo $row['accesstype'];?></td>
                   <td><?php echo $row['datedenais'];?></td>


                  <td>
                    <a class="btn btn-sm btn-white" href="modifierUtilisateur.php?idutilisateur=<?PHP echo $row['idutilisateur']; ?>">
                      <i class="tio-edit"></i> Edit
                    </a>
                  </td>
                   <td>
                   <a class="btn btn-sm btn-outline-danger" href="supprimerUtilisateur.php?idutilisateur=<?PHP echo $row['idutilisateur']; ?>">
                        <i class="tio-delete-outlined"></i> Delete
                      </a>
                  </td>
                </tr>
