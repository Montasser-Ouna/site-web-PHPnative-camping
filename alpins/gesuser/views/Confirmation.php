...
$error = "";
 ...
 {      echo '<script>
      alert("Now login again to join the club administrators list in Camping Fever!");
    
         </script>';
         header('Location:login.php?idutilisateur='.$row['idutilisateur']);}
       else 
       echo '<script>
      alert("Failed to login :veuillez vérifiez votre adresse et votre nouveau mot de passe !");
...
<html lang="en">
    <head>
       <meta charset="utf-8" />
        ...
        <title>Page Title - Confirmation</title>
...
<!-- Input Group -->
<div class="form-group">
  <label for="inputGroupBorderlessEmailOptional" class="input-label">Nouveau mot de passe <span class="input-label-secondary"></span></label>
