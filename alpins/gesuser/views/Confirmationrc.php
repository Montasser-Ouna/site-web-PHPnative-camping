...
$error = "";
   ...
   if (
    ...
    {
 if(strcmp($row['nom'],$_POST["nom"])==0 && strcmp($row['prenom'],$_POST["prenom"])==0 && strcmp($_POST["choix"],"respensable du club")==0)
   {header('Location:addclub.php?idutilisateur='.$row['idutilisateur']);}
