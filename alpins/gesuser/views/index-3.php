...
<!-- Mirrored from templates.themekit.dev/alpins/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Nov 2020 06:15:26 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="page-main">
            ...
            <div class="menu-cnt">
                <ul id="main-menu">
                    <li class="dropdown">
                        ...
                        <li class="dropdown">
                            <a href="gesuser/views/register.php">Register</a>
                        </li>
                    </li>
                    <li class="dropdown">
                        <a href="#">Pages</a>
                        <ul>
                            <li class="dropdown-submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="team-2.php">Team two</a></li>
                                </ul>
                            </li>
                            <li class="dropdown-submenu">
                                <a>Special</a>
                    ...
                    <li class="dropdown">
                        <a href="treks.php">Treks</a>
                        <ul>
                            <li><a href="treks.php">Treks</a></li>
                            <li><a href="treks-single.php">Single trek</a></li>
                        </ul>
                    </li>
                    <li>
                ...
                <div class="menu-right">
                    <ul class="lan-menu">
                        ...
                        <ul class="lan-menu">
                        <li >
                            <a href="gesuser/views/login.php"><img src="media/18764668.jpg" width="20" height="20" alt="lang" />Login</a>
    ...
    <main>
        <section class="section-image section-home-alpins light" style="background-image:url(media/hd-13.jpg)">
            <div class="container">
                <hr class="space-lg" />
                <div class="row">
                    <div class="col-lg-9">
        ...
        <section class="section-base section-color">
            <div class="container">
                <ul class="slider" data-options="type:carousel,arrows:true,perView:3,perViewLg:2,perViewMd:1,gap:30,controls:out">
                    <li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <a href="treks.html" class="btn btn-sm btn-circle btn-icon"><i class="im-geo2-love"></i>View treks</a>
                    </div>
                    <div class="col-lg-8">
                            ...
                            <li>
                                ...
                                <div class="content">
                                    <p>
                                        ...
                                        Utenim ad minim veniam quis nostrud exercitation dipiscing elitsed do esectetur adipiscing elitsed do eiusmoiusmod tem.
                                    </p>
                                </div>
                            </li>
                            <li>
        ...
        <section class="section-image light" data-parallax="true" data-natural-height="1080" data-natural-width="1920" data-bleed="100" data-image-src="media/hd-6.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="progress-circle light text-black" data-color="#379cf4" data-thickness="6" data-progress="100" data-linecap="round" data-options="emptyFill:#FFF">
                            <div class="content">
                                <h4>Treks</h4>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="progress-circle light text-black" data-color="#379cf4" data-thickness="6" data-progress="80" data-linecap="round" data-options="emptyFill:#FFF">
                            <div class="content">
                                <h4>Excursions</h4>
                    ...
                    <div class="col-lg-6">
                        ...
                        <p>Lorem ipsum dolor sit ame tion ullamco laboris nisi ut aliqu r in reprehenderit ma quiese nostrud exercitation iconsectetur adipiscing elitsed do eiusmo fugiat nulla pariatur.</p>
                    </div>
                </div>
            </div> 
        </section>
        <section class="section-base">
            <div class="container">
                <ul class="slider" data-options="type:carousel,perView:5,perViewMd:4,perViewSm:3,perViewXs:1,gap:70,autoplay:3500">
                    <li>
                        <img src="media/logos/logo-1.png"  alt="logo" />
                    </li>
                    <li>
                        <img src="media/logos/logo-2.png" alt="logo" />
                    </li>
                    <li>
                        <img src="media/logos/logo-3.png" alt="logo" />
                    </li>
                    <li>
                        <img src="media/logos/logo-4.png" alt="logo" />
                    </li>
                    <li>
                        <img src="media/logos/logo-5.png" alt="logo" />
                    </li>
                    <li>
                        <img src="media/logos/logo-6.png" alt="logo" />
                    </li>
                </ul>
            </div>
        </section>
        <section class="section-base section-color">
            <div class="container">
                ...
                <div class="grid-list pagination-top-right" data-columns="4" data-columns-lg="3" data-columns-md="2" data-columns-sm="1">
                    <div class="grid-box">
                        <div class="grid-item">
                            <div class="cnt-box cnt-box-badge boxed">
                                <a href="#" class="img-box"><img src="media/image-1.jpg" alt="" /></a>
                                <div class="caption">
                        ...
                        <div class="grid-item">
                            <div class="cnt-box cnt-box-badge boxed">
                                <a href="#" class="img-box"><img src="media/image-3.jpg" alt="" /></a>
                                <div class="caption">
                        ...
                        <div class="grid-item">
                            <div class="cnt-box cnt-box-badge boxed">
                                <a href="#" class="img-box"><img src="media/image-4.jpg" alt="" /></a>
                                <div class="caption">
                    ...
                    <div class="list-pagination">
                        <ul class="pagination align-center" data-page-items="4" data-page-items-lg="3" data-page-items-md="2" data-pagination-anima="fade-right"></ul>
                    </div>
                </div>
            </div>
        </section>
...
<!-- Mirrored from templates.themekit.dev/alpins/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Nov 2020 06:15:28 GMT -->
</html>