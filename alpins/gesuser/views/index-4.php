...
<!-- Mirrored from templates.themekit.dev/alpins/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Nov 2020 06:15:28 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Home | 3 | Alpins | Mountain And Trekking Template</title>
...
<body class="page-main">
            ...
            <div class="menu-cnt">
                <ul id="main-menu">
                    <li class="dropdown">
                        <a href="#">Home</a>
                        <ul>
                            <li><a href="index-2.php">Main</a></li>
    ...
    <main>
        <section class="section-image light ken-burn-center" data-parallax="scroll" data-image-src="media/hd-12.jpg">
            <div class="container">
                <hr class="space-lg" />
                <hr class="space-sm" />
                <div class="row justify-content-around">
                    <div class="col-lg-6">
                        <h1 data-anima="fade-left" data-time="2000" class="text-lg text-uppercase text-black">Stunning high treks</h1>
                        <hr class="space-sm" />
                        <hr class="space-xs" />
                        <table data-anima="fade-left" data-time="3000" class="table table-grid table-border align-left table-10">
                            <tbody>
                                <tr>
                                    <td>
                        ...
                        <hr class="space-sm" />
                        <hr class="space-xs" />
                        <a href="treks.html" class="btn btn-sm btn-circle" data-anima="fade-left" data-time="3000">View treks</a>
                        <a href="team.html" class="btn btn-sm btn-circle btn-border" data-anima="fade-left" data-time="3000">View team</a>
                    </div>
                    <div class="col-lg-5 align-right align-left-md">
                        <hr class="space visible-md" />
                        <ul class="slider" data-options="type:slider,perView:1,nav:true,autoplay:3500,controls:out" data-anima="fade-right" data-time="2000">
                            <li>
        ...
        <section class="section-base section-color section-call">
            <div class="container">
                ...
                <ul class="slider" data-options="type:carousel,arrows:true,perView:4,perViewMd:3,perViewSm:2,perViewXs:1,gap:30,controls:out,autoplay:3000">
                    <li>
                        <a class="img-box lightbox img-box-caption" href="media/long-9.jpg" data-lightbox-anima="fade-left">
                            <img src="media/long-9.jpg" alt="">
                            <span>Dolomiti mountains</span>
                        </a>
                    </li>
                    <li>
                        <a class="img-box lightbox img-box-caption" href="media/long-10.jpg" data-lightbox-anima="fade-left">
                            <img src="media/long-10.jpg" alt="">
                            <span>Civetta mountain</span>
                        </a>
                    </li>
                    <li>
                        <a class="img-box lightbox img-box-caption" href="media/long-11.jpg" data-lightbox-anima="fade-left">
                            <img src="media/long-11.jpg" alt="">
                            <span>San Pellegrino</span>
                        </a>
                    </li>
                    <li>
                        <a class="img-box lightbox img-box-caption" href="media/long-12.jpg" data-lightbox-anima="fade-left">
                            <img src="media/long-12.jpg" alt="">
                            <span>Nevegal mountain</span>
                        </a>
                    </li>
                    <li>
                        <a class="img-box lightbox img-box-caption" href="media/long-13.jpg" data-lightbox-anima="fade-left">
                            <img src="media/long-13.jpg" alt="">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 no-margin-md">
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipiscing elitsed do eiusmod tempor incididunt utlabore eud exercitation ullamco laboris nisi ut alit dolore magna aliqua.
                    ...
                    <div class="col-lg-4">
                        <ul class="text-list text-list-line line-4">
                            <li><b>Foundation</b><hr /><p>1995</p></li>
                            <li><b>Address</b><hr /><p>Civetta, Trentino, Italy</p></li>
                            <li><b>Email</b><hr /><p>name@example.com</p></li>
                            <li><b>Phone and fax</b><hr /><p>(02) 123 44 55 666</p></li>
                            <li><b>Team members</b><hr /><p>10+</p></li>
                            <li><b>Treks and paths</b><hr /><p>15+</p></li>
                            <li><b>Starting price</b><hr /><p>from $ 50</p></li>
                            <li><b>Founder</b><hr /><p>Alex Dimitri</p></li>
                        </ul> 
                    </div>
                </div>
            </div>
        </section>
        <section class="section-image light" data-parallax="true" data-natural-height="1080" data-natural-width="1920" data-bleed="100" data-image-src="media/hd-1.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p>Lorem ipsum dolor sit ame tion ullamco laboris nisi ut aliqure in reprehenderit ma quiese nostrud exercitation iconsectetur adipiscing elitsed do eiusmo fugiat nulla pariatur.</p>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="grid-box">
                        <div class="grid-item">
                            <div class="cnt-box cnt-box-info boxed" data-href="treks-single.html">
                                ...
                                <a href="treks-single.html" class="img-box"><img src="media/image-4.jpg" alt="" /></a>
                                <div class="caption">
                                    ...
                                    <p>
                                        Glacial is a mountain glacier located in the nature and lakes.
                                    </p>
                        ...
                        <div class="grid-item">
                            <div class="cnt-box cnt-box-info boxed" data-href="treks-single.html">
                                ...
                                <a href="treks-single.html" class="img-box"><img src="media/image-15.jpg" alt="" /></a>
                                <div class="caption">
                                    <h2>Family trip</h2>
                                    <div class="cnt-info">
                                        <div><span>Days</span><span>3</span></div>
                                    ...
                                    <p>
                                        A trip for the whole family located in the nature and lakes.
                                    </p>
                                    <div class="bottom-info">
                        ...
                        <div class="grid-item">
                            <div class="cnt-box cnt-box-info boxed" data-href="treks-single.html">
                                ...
                                <div class="caption">
                                    ...
                                    <p>
                                        Monte Albert is a mountain located in the nature and lakes.
                                    </p>
                                    <div class="bottom-info">
                                        Albert, Colorado, US
                                    </div>
                        ...
                        <div class="grid-item">
                            <div class="cnt-box cnt-box-info boxed" data-href="treks-single.html">
                                ...
                                <div class="caption">
                                    ...
                                    <p>
                                        Monte bianco is a mountain located in the nature and lakes.
                                    </p>
                                    <div class="bottom-info">
                        ...
                        <div class="grid-item">
                            <div class="cnt-box cnt-box-info boxed" data-href="treks-single.html">
                                ...
                                <div class="caption">
                                    ...
                                    <p>
                                        Civetta mountain is a mountain located in the nature and lakes.
                                    </p>
                                    <div class="bottom-info">
        ...
        <section class="section-base section-color">
            <div class="container">
                <div class="social-feed social-feed-tw social-slider" data-social-id="twitter" data-options="count:8,arrows:true,controls:out,type:carousel,perViewXs:1,,perViewSm:2,perViewLg:3,perView:4,gap:60"></div>
            </div>
        </section>
    </main>
    <footer class="light">
...
<!-- Mirrored from templates.themekit.dev/alpins/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Nov 2020 06:15:30 GMT -->
</html>