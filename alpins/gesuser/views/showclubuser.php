...
<span class="Reassurance-img"><a href="#">
          ...
          <span class="Reassurance-img"><a href="#">
              <img class=" lazyloaded" data-src="https://cdn4.iconfinder.com/data/icons/pr-marketing-color-filled/5000/PR-marketing-icon-set-color-3-512.png" src="https://cdn4.iconfinder.com/data/icons/pr-marketing-color-filled/5000/PR-marketing-icon-set-color-3-512.png" width="90" height="90">Consulter evenement
            </a>
          </span>
          <br>
          <div class="col-sm-5 col-xs-6 title" >Description:</div><div class="col-sm-7 col-xs-6 "><?php echo $row['description'];?></div>
