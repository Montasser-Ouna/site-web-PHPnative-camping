                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <input  class="form-control py-4" type="date" id="datenais" name="datenais">
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputtel" type="telephone" placeholder="216+" />
                                                    </div>
                                                </div>
                                            </div>
                                               ...
                                               <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="user"  value="option1">
                                               <label class="form-check-label" for="inlineCheckbox1">User</label>
                                               </div>
                                              <div class="form-check form-check-inline">
                                               <input class="form-check-input" type="checkbox" id="inlineCheckbox1" 
                                               name="club "value="option2">
                                             <label class="form-check-label" for="inlineCheckbox2">Club</label>
                                              
                                          </div>
                                            </div>
                                            <div class="form-group mt-4 mb-0"><a class="btn btn-primary btn-block" href="login.html">Créer compte</a></div>
                                       </form> 
                                    </div>
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="loginuser.html">Vous avez deja un compte? Go to login</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
