...
<html lang="en">
<?php
include "projet_site-web-group3/alpins/gesuser/Model/Utilisateur.php";
    include "projet_site-web-group3/alpins/gesuser/Controller/UtilisateurC.php";?>
<!-- Mirrored from templates.themekit.dev/alpins/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Nov 2020 06:15:10 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="page-main">
    ...
    <nav class="menu-classic menu-fixed menu-transparent light align-right" data-menu-anima="fade-in">
        ...
        <!-- div class form <form action="showuser.php"> <input type="hidden" id="myFile" value="1234"> -->
                <div class="menu-right">
                    <ul class="lan-menu">
                        <li class="dropdown">
                            ...
                            <ul class="lan-menu">
                        <li >
                            <a href="showuser.php"><img src="media/18764668.jpg" width="30" height="20" alt="lang" /></a>
    ...
    <main>
        <section class="section-image section-full-width-right light ken-burn-center" data-parallax="scroll" data-image-src="media/hd-1.jpg">
            <div class="container">
                <hr class="space-lg" />
                <hr class="space-sm" />
                <div class="row">
...
<!-- Mirrored from templates.themekit.dev/alpins/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Nov 2020 06:15:24 GMT -->
</html>