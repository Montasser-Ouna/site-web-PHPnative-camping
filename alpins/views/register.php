<?php
    ...
    if (
        ...
        {$e=$UtilisateurC->afficherUtilisateurs();
           $tesst==0; 
           foreach ($e as $k) 
            {
                  if(strcmp($_POST['email'],$k['email'])==0)
                   { $tesst=1;
                echo 'yesss';}
            } }
     if (!empty($_POST["email"])&&($tesst!=1)&&
            !empty($_POST["nom"]) &&
            !empty($_POST["prenom"]) &&
...
echo 'alert("Erreur ! Cet email existe déja ! Veuillez essayer un autre ou bien vous connecter")';
echo '</script>';         
  }
                                        ...
                                        <div class="card-body">
                                            <form action="" onsubmit="return verif()" method="POST">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" id="validationValidFileInput1" class="custom-file-input is-valid" name="pdp">
                                                    <label class="form-control custom-file-label" for="validationValidFileInput1">Ajouter votre photo de profil(optionel)</label>
                                                </div>
