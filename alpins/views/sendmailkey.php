...
$user=new Utilisateur(
               $row["nom"],
                $row["prenom"],
                $row["email"], $row["datedenais"],$row["keyconfirmation"],$row["keyconfirmation"],$row["ville"], $row["tel"],$row["accesstype"],$_POST["pdp"]
            );
	...
	<body>
		<div align="center">
		 ...
		 <h1>Vous trouerz le nouveau mot de passe ci dessous</h1>
			...
			<a href="http://localhost/projet_site-web_group3/alpins/gesuser/views/Confirmation.php?idutilisateur='.$row['idutilisateur'].'"> Cliquez ici pour confirmer votre compte : </a>
			<br />
		</div>
	</body>
</html>
